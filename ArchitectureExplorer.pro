...
ArchitectureExplorerRootPath=/home/brian/Documents/Unreal Projects/ArchitectureExplorer

gameProjectFile=/home/brian/Documents/Unreal Projects/ArchitectureExplorer/ArchitectureExplorer.uproject
...
include(ArchitectureExplorerSource.pri)
include(ArchitectureExplorerHeader.pri)
include(ArchitectureExplorerConfig.pri)
include(ArchitectureExplorerIncludes.pri)
include(ArchitectureExplorerDefines.pri)

ArchitectureExplorer-Linux-Debug.commands = $$build ArchitectureExplorer Linux Debug  -project="\"$$gameProjectFile\"" $$args
ArchitectureExplorer-Linux-DebugGame.commands = $$build ArchitectureExplorer Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
ArchitectureExplorer-Linux-Shipping.commands = $$build ArchitectureExplorer Linux Shipping  -project="\"$$gameProjectFile\"" $$args
ArchitectureExplorer-Linux-Test.commands = $$build ArchitectureExplorer Linux Test  -project="\"$$gameProjectFile\"" $$args
ArchitectureExplorer.commands = $$build ArchitectureExplorer Linux Development  -project="\"$$gameProjectFile\"" $$args

ArchitectureExplorerEditor-Linux-Debug.commands = $$build ArchitectureExplorerEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
ArchitectureExplorerEditor-Linux-DebugGame.commands = $$build ArchitectureExplorerEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
ArchitectureExplorerEditor-Linux-Shipping.commands = $$build ArchitectureExplorerEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
ArchitectureExplorerEditor-Linux-Test.commands = $$build ArchitectureExplorerEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
ArchitectureExplorerEditor.commands = $$build ArchitectureExplorerEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	ArchitectureExplorer-Linux-Debug \
	ArchitectureExplorer-Linux-DebugGame \
	ArchitectureExplorer-Linux-Shipping \
	ArchitectureExplorer-Linux-Test \
	ArchitectureExplorer \
	ArchitectureExplorerEditor-Linux-Debug \
	ArchitectureExplorerEditor-Linux-DebugGame \
	ArchitectureExplorerEditor-Linux-Shipping \
	ArchitectureExplorerEditor-Linux-Test \
	ArchitectureExplorerEditor \
