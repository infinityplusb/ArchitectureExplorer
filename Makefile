...
ArchitectureExplorer-Linux-Debug:
	 $(PROJECTBUILD) ArchitectureExplorer Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ArchitectureExplorer-Linux-DebugGame:
	 $(PROJECTBUILD) ArchitectureExplorer Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ArchitectureExplorer-Linux-Shipping:
	 $(PROJECTBUILD) ArchitectureExplorer Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

ArchitectureExplorer-Linux-Test:
	 $(PROJECTBUILD) ArchitectureExplorer Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

ArchitectureExplorer:
	 $(PROJECTBUILD) ArchitectureExplorer Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

ArchitectureExplorerEditor-Linux-Debug:
	 $(PROJECTBUILD) ArchitectureExplorerEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ArchitectureExplorerEditor-Linux-DebugGame:
	 $(PROJECTBUILD) ArchitectureExplorerEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ArchitectureExplorerEditor-Linux-Shipping:
	 $(PROJECTBUILD) ArchitectureExplorerEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

ArchitectureExplorerEditor-Linux-Test:
	 $(PROJECTBUILD) ArchitectureExplorerEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

ArchitectureExplorerEditor:
	 $(PROJECTBUILD) ArchitectureExplorerEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
